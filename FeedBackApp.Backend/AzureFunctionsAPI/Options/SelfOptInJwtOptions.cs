...
namespace AzureFunctionsAPI.Options;

public sealed class SelfOptInJwtOptions
{
    public bool Enabled { get; set; } = true;
    
    public string Issuer { get; set; } = "feedback-app.optin";      // who wrote it
    public string Audience { get; set; } = "feedback-app.optin";    // who received it
    
    public string SigningKey { get; set; } = "f9W8zP4vQjL7mX2sTdNz6YrUaV0KeH1Cb"; // JWT secret key
    
    // default TTL for new links
