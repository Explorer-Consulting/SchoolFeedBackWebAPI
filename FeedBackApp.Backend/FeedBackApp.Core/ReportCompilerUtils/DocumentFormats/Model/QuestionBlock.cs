...
namespace FeedBackApp.Core.ReportCompilerUtils.DocumentFormats.Model
{
    ...
    public sealed class QuestionBlock
    {
        ...
        /// </summary>
        public IReadOnlyList<IReadOnlyList<string>> HeaderRows { get; set; } = [];

        /// <summary>
        /// The options rows containing predefined answer choices.
        /// </summary>
        public IReadOnlyList<IReadOnlyList<string>> OptionRows { get; set; } = [];

        /// <summary>
        /// The answers rows containts the answers and their number. 
        /// </summary> 
        public IReadOnlyList<IReadOnlyList<string>> AnswerRows { get; set; } = [];
    }
}
