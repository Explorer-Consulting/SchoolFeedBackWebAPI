...
namespace Core.DomainModels
{
    public sealed class QuestionnaireTemplate() : IAggregateRoot
    {
        ...
        public required string QuestionnaireTemplateStorageID { get; set; }
        // Business ID for application logic
        public required string QuestionnaireTemplateBusinessID { get; set; }
        // Metadata about the questionnaire template
        public required QuestionnaireTemplateMetadata Metadata { get; set; }
